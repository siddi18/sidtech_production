...
const Header = () => {
             ...
             <button
                 ...
                 className="text-white flex items-center" >
                  ...
                  <FiUser className="mr-1" />
                        ...
                        <ul className={`absolute ${isProfileMenuOpen ? 'block' : 'hidden'
                            ...
                            <li>
                                <Link to="/logoutUser" onClick={handleLogout}>
    ...
    const handleSearch = (e) => {
        e.preventDefault()
        if (keyword) {
            console.log('key frm handlesearch :',keyword)
        ...
        <nav className="bg-gray-800 p-4">
            <div className="flex items-center justify-between">
                ...
                <div className="hidden sm:flex items-center space-x-4">
                  ...
                  {userInfo.userInfo &&  <div className="relative group">
                       {renderProfileButton()}
                    </div>}
                    {userInfo.userInfo?.isAdmin && <div className="relative group ">
                        {renderAdminButton()}
                    </div>}
                    
                    {!userInfo.userInfo && renderSignInButton()}
                </div>
